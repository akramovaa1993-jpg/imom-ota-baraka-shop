...
app.get('/api/status',(req,res)=>res.json({ok:true,version:'13.26.16',telegramConfigured:Boolean(BOT_TOKEN&&CHAT_ID),adminOnline:true,storage:pool?'postgresql':'local-json',persistent:Boolean(pool),dataFile:DB_FILE}));
